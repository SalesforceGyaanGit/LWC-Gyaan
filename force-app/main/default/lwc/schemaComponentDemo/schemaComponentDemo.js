...
import getSingleContact from "@salesforce/apex/MB_HospitalObj.getSingleContact";

import NAME_FIELD from "@salesforce/schema/Contact.Name";
import TITLE_FIELD from "@salesforce/schema/Contact.Title";
import EMAIL_FIELD from "@salesforce/schema/Contact.Email";
export default class SchemaComponentDemo extends LightningElement {
@wire(getSingleContact) contact;

  get name() {
    console.log('getSObjectValue == '+getSObjectValue);
